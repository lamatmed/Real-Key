    ...
    return (
        <nav className="flex bg-black/95 backdrop-blur-sm justify-between items-center border-b border-slate-800 px-6 py-4 w-full text-white text-lg sticky top-0 z-50">
            ...
            <div className="hidden md:flex items-center gap-4">
                <Button
                    variant="outline"
                    className="border-slate-600 hover:bg-slate-800 hover:border-slate-500 text-white px-6 py-2 rounded-full font-medium transition-all duration-300"
                >
                    Contact
                </Button>
            ...
            <div className={`absolute top-full left-0 w-full bg-black/95 backdrop-blur-sm border-b border-slate-800 flex-col items-center gap-4 py-6 px-4 transition-all duration-300 ${
                ...
                <div className="flex flex-col gap-3 w-full max-w-xs mt-2">
                    <Button
                        variant="outline"
                        className="border-slate-600 hover:bg-slate-800 text-white w-full py-3 rounded-full font-medium transition-all duration-300"
                    >
                        Contact
                    </Button>
